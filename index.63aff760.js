...
*/ const OVERLAY_ID = '__parcel__error__overlay__';
    ...
    if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
      ...
      const ws = new WebSocket(`${protocol}://${hostname}${port ? `:${port}` : ''}/`); // Web extension context
    ...
    function createErrorOverlay(diagnostics) {
      ...
      for (const diagnostic of diagnostics) {
        const stack = diagnostic.frames.length ? diagnostic.frames.reduce((p, frame) => `${p}
<a href="/__parcel_launch_editor?file=${encodeURIComponent(frame.location)}" style="text-decoration: underline; color: #888" onclick="fetch(this.href); return false">${frame.location}</a>
${frame.code}`, '') : diagnostic.stack;
        errorHTML += `
      <div>
    ...
    function reloadCSS() {
      ...
      cssTimeout = setTimeout(() => {
        ...
        // $FlowFixMe[incompatible-type]
          ...
          const absolute = /^https?:\/\//i.test(href) && href.indexOf(location.origin) !== 0 && !servedFromHMRServer;
  ...
  adjPd: [function (require, module, exports) {
    const _hastUtilToHtml = require('hast-util-to-html');
    const _glsf = require('glsf');
  ...
  }, { glsf: '8nXCR', 'hast-util-to-html': 'c898u' }],
  '8nXCR': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    const _elementsJs = require('./elements.js');
    parcelHelpers.exportAll(_elementsJs, exports);
    const _renderJs = require('./render.js');
    parcelHelpers.exportAll(_renderJs, exports);
  }, { './elements.js': 'dSAVW', './render.js': '2J047', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  dSAVW: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    ...
    const _unistBuilder = require('unist-builder');
    const doc = (content) => (0, _unistBuilder.u)('root', content);
    ...
    const token = (tokenId, fa2) => (0, _unistBuilder.u)('token', {
      tokenId,
      fa2,
    });
  ...
  }, { 'unist-builder': '4XY8i', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '4XY8i': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ function (type, props, value) {
  ...
  '2J047': [function (require, module, exports) {
    ...
    const _unistUtilMap = require('unist-util-map');
    const _hastscript = require('hastscript');
    const _hastUtilToHtml = require('hast-util-to-html');
    // Const tree = u('root', [
    //   u('subtree', {id: 1}),
    //   u('subtree', {id: 2}, [
    ...
    const render = (tree) => (0, _unistUtilMap.map)(tree, (node) => {
      if (node.type === 'root') return (0, _hastscript.h)('div', getAttrs(node), node.children);
      if (node.type === 'paragraph') return (0, _hastscript.h)('p', getAttrs(node), node.children);
      if (node.type === 'heading') return (0, _hastscript.h)(`h${node.level}`, getAttrs(node), node.children);
      ...
      if (node.type === 'image') {
        ...
        if (node.attrs['aspect-ratio']) attrs.style = `aspect-ratio: ${node.attrs['aspect-ratio']}`;
        return (0, _hastscript.h)('img', attrs);
      }
      return node;
    });
  }, {
    'unist-builder': '4XY8i', 'unist-util-visit': 'b1dAt', 'unist-util-map': '1MRFO', hastscript: '80quX', 'hast-util-to-html': 'leF5i', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  b1dAt: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ var _unistUtilVisitParents = require('unist-util-visit-parents');
  ...
  }, { 'unist-util-visit-parents': 'WzqqF', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  WzqqF: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ const _unistUtilIs = require('unist-util-is');
    const _colorJs = require('./color.js');
    const CONTINUE = true;
    const SKIP = 'skip';
    const EXIT = false;
    const visitParents = /**
 ...
 */ function toResult(value) {
  ...
  }, { 'unist-util-is': 'i2Rbn', './color.js': '5bkby', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  i2Rbn: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ function castFactory(check) {
  ...
  '5bkby': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {string} d
 ...
 */ parcelHelpers.export(exports, 'color', () => color);
  ...
  '1MRFO': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef {import('unist').Node} Node
 ...
 */ parcelHelpers.export(exports, 'map', () => map);
    ...
    // @ts-expect-error Looks like a children.
      ...
      /** @type {import('./complex-types').MapFunction<Tree>} */ function preorder(node, index1, parent) {
        const newNode = { ...iteratee(node, index1, parent) };
        if ('children' in node) {
        // @ts-expect-error Looks like a parent.
          newNode.children = node.children.map((/** @type {import('./complex-types').InclusiveDescendant<Tree>} */ child, /** @type {number} */ index) => preorder(child, index, node));
        }
        return newNode;
      }
    }
  }, { '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '80quX': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'h', () => (0, _indexJs.h));
  ...
  }, { './lib/index.js': 'crYeI', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  crYeI: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'h', () => (0, _htmlJs.h));
  ...
  }, { './html.js': 'gsTRl', './svg.js': 'lI1PM', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  gsTRl: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ const _propertyInformation = require('property-information');
    const _coreJs = require('./core.js');
    const h = (0, _coreJs.core)((0, _propertyInformation.html), 'div');
  }, { 'property-information': 'gJnAE', './core.js': '7ZMRa', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  gJnAE: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ const _mergeJs = require('./lib/util/merge.js');
    const _xlinkJs = require('./lib/xlink.js');
    const _xmlJs = require('./lib/xml.js');
    const _xmlnsJs = require('./lib/xmlns.js');
    const _ariaJs = require('./lib/aria.js');
    const _htmlJs = require('./lib/html.js');
    const _svgJs = require('./lib/svg.js');
    ...
    './lib/util/merge.js': '2FmLM', './lib/xlink.js': '9gW8u', './lib/xml.js': 'e9ef2', './lib/xmlns.js': 'e8tNT', './lib/aria.js': 'CnWCO', './lib/html.js': 'eOFqD', './lib/svg.js': '1rj1q', './lib/find.js': '4VgLG', './lib/hast-to-react.js': false, './lib/normalize.js': 'ahd5Y', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '2FmLM': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ const _schemaJs = require('./schema.js');
  ...
  }, { './schema.js': '6dI93', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '6dI93': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'Schema', () => Schema);
  ...
  '9gW8u': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'xlink', () => xlink);
    const _createJs = require('./util/create.js');
  ...
  }, { './util/create.js': 'hyYO6', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  hyYO6: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ const _normalizeJs = require('../normalize.js');
    const _schemaJs = require('./schema.js');
    const _definedInfoJs = require('./defined-info.js');
    ...
    '../normalize.js': 'ahd5Y', './schema.js': '6dI93', './defined-info.js': 'dJvQj', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  ahd5Y: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {string} value
 ...
 */ parcelHelpers.export(exports, 'normalize', () => normalize);
  ...
  dJvQj: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'DefinedInfo', () => DefinedInfo);
    const _infoJs = require('./info.js');
    const _typesJs = require('./types.js');
 ...
 */ function mark(values, key, value) {
  ...
  }, { './info.js': '7NT0d', './types.js': '5bGAV', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '7NT0d': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  '5bGAV': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  e9ef2: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  e8tNT: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'xmlns', () => xmlns);
    const _createJs = require('./util/create.js');
    const _caseInsensitiveTransformJs = require('./util/case-insensitive-transform.js');
  ...
  }, { './util/create.js': 'hyYO6', './util/case-insensitive-transform.js': '5t72J', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '5t72J': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'caseInsensitiveTransform', () => caseInsensitiveTransform);
    const _caseSensitiveTransformJs = require('./case-sensitive-transform.js');
    function caseInsensitiveTransform(attributes, property) {
      return (0, _caseSensitiveTransformJs.caseSensitiveTransform)(attributes, property.toLowerCase());
    }
  }, { './case-sensitive-transform.js': 'JWsdM', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  JWsdM: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Record<string, string>} attributes
 ...
 */ parcelHelpers.export(exports, 'caseSensitiveTransform', () => caseSensitiveTransform);
  ...
  CnWCO: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'aria', () => aria);
    const _typesJs = require('./util/types.js');
    const _createJs = require('./util/create.js');
  ...
  }, { './util/types.js': '5bGAV', './util/create.js': 'hyYO6', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  eOFqD: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'html', () => html);
    const _typesJs = require('./util/types.js');
    ...
    './util/types.js': '5bGAV', './util/create.js': 'hyYO6', './util/case-insensitive-transform.js': '5t72J', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '1rj1q': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'svg', () => svg);
    const _typesJs = require('./util/types.js');
    const _createJs = require('./util/create.js');
    const _caseSensitiveTransformJs = require('./util/case-sensitive-transform.js');
    ...
    './util/types.js': '5bGAV', './util/create.js': 'hyYO6', './util/case-sensitive-transform.js': 'JWsdM', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '4VgLG': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Schema} schema
 ...
 */ const _normalizeJs = require('./normalize.js');
    const _definedInfoJs = require('./util/defined-info.js');
    const _infoJs = require('./util/info.js');
 ...
 */ function camelcase($0) {
    ...
    './normalize.js': 'ahd5Y', './util/defined-info.js': 'dJvQj', './util/info.js': '7NT0d', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '7ZMRa': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Schema} schema
 ...
 */ const _propertyInformation = require('property-information');
    const _hastUtilParseSelector = require('hast-util-parse-selector');
          ...
          if (selector === undefined || selector === null) {
            ...
            /** @type {string} */ let key;
              for (key in properties) {
                if (own.call(properties, key)) // @ts-expect-error `node.properties` is set.
 ...
 */ function createAdjustMap(values) {
    ...
    'property-information': 'gJnAE', 'hast-util-parse-selector': '38Qdj', 'space-separated-tokens': '12UjR', 'comma-separated-tokens': 'aekes', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '38Qdj': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ const search = /[#.]/g;
  ...
  '12UjR': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'stringify', () => stringify);
  ...
  aekes: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'stringify', () => stringify);
  ...
  lI1PM: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ const _propertyInformation = require('property-information');
    const _coreJs = require('./core.js');
    const _svgCaseSensitiveTagNamesJs = require('./svg-case-sensitive-tag-names.js');
    const s = (0, _coreJs.core)((0, _propertyInformation.svg), 'g', (0, _svgCaseSensitiveTagNamesJs.svgCaseSensitiveTagNames));
  }, {
    'property-information': 'gJnAE', './core.js': '7ZMRa', './svg-case-sensitive-tag-names.js': '2JAx0', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '2JAx0': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  leF5i: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'toHtml', () => (0, _indexJs.toHtml));
    var _indexJs = require('./lib/index.js');
  }, { './lib/index.js': '5bMMu', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '5bMMu': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ const _propertyInformation = require('property-information');
    const _htmlVoidElements = require('html-void-elements');
    const _indexJs = require('./omission/index.js');
    const _treeJs = require('./tree.js');
    function toHtml(node, options = {}) {
      ...
      return (0, _treeJs.one)(
        context, // @ts-ignore Assume `node` does not contain a root.
        Array.isArray(node) ? {
          type: 'root',
          children: node,
        } : node,
    ...
    'property-information': 'gJnAE', 'html-void-elements': 'hObSN', './omission/index.js': 'e5Sq2', './tree.js': 'bLfC4', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  hObSN: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  e5Sq2: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'omission', () => omission);
    /**
 * @typedef {import('../types.js').Omission} Omission
 */ const _openingJs = require('./opening.js');
    const _closingJs = require('./closing.js');
    const omission = {
      opening: (0, _openingJs.opening),
      closing: (0, _closingJs.closing),
    };
  }, { './opening.js': 'hTyfS', './closing.js': 'hKb6l', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  hTyfS: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ const _hastUtilIsElement = require('hast-util-is-element');
    const _commentJs = require('./util/comment.js');
    const _siblingsJs = require('./util/siblings.js');
    const _whitespaceStartJs = require('./util/whitespace-start.js');
    const _closingJs = require('./closing.js');
    const _omissionJs = require('./omission.js');
 ...
 */ function tbody(node, index, parent) {
    ...
    'hast-util-is-element': '703HB', './util/comment.js': 'aA3yG', './util/siblings.js': '8iyab', './util/whitespace-start.js': '7uhqP', './closing.js': 'hKb6l', './omission.js': 'lERIk', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '703HB': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ function element(node) {
  ...
  aA3yG: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ const _unistUtilIs = require('unist-util-is');
  ...
  }, { 'unist-util-is': 'i2Rbn', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '8iyab': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ function siblings(increment) {
  ...
  }, { 'hast-util-whitespace': 'YMnLj', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  YMnLj: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {unknown} thing
 ...
 */ parcelHelpers.export(exports, 'whitespace', () => whitespace);
    ...
    /** @type {string} */ const value = // @ts-ignore looks like a node.
 ...
 */ const _unistUtilIs = require('unist-util-is');
  ...
  }, { 'unist-util-is': 'i2Rbn', 'hast-util-whitespace': 'YMnLj', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  hKb6l: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
 ...
 */ function cells(_, index, parent) {
    ...
    'hast-util-is-element': '703HB', './util/comment.js': 'aA3yG', './util/siblings.js': '8iyab', './util/whitespace-start.js': '7uhqP', './omission.js': 'lERIk', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  lERIk: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ const own = {}.hasOwnProperty;
  ...
  bLfC4: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
 ...
 */ const _propertyInformation = require('property-information');
    const _spaceSeparatedTokens = require('space-separated-tokens');
    const _commaSeparatedTokens = require('comma-separated-tokens');
    const _stringifyEntities = require('stringify-entities');
    const _ccount = require('ccount');
    const _constantsJs = require('./constants.js');
    const _commentJs = require('./comment.js');
    const _doctypeJs = require('./doctype.js');
    const _rawJs = require('./raw.js');
 ...
 */ // eslint-disable-next-line complexity
    function serializeAttribute(ctx, key, value) {
      ...
      const name = (0, _stringifyEntities.stringifyEntities)(info.attribute, {
        ...ctx.entities, // Always encode without parse errors in non-HTML.
      ...
      if (ctx.unquoted) {
        result = (0, _stringifyEntities.stringifyEntities)(value, {
          ...ctx.entities,
      ...
      // If the alternative is less common than `quote`, switch.
        ...
        result = quote + (0, _stringifyEntities.stringifyEntities)(value, {
          ...ctx.entities, // Always encode without parse errors in non-HTML.
    ...
    'property-information': 'gJnAE', 'space-separated-tokens': '12UjR', 'comma-separated-tokens': 'aekes', 'stringify-entities': 'j5aki', ccount: 'a7P1B', './constants.js': '3Z5AU', './comment.js': 'fNZ7O', './doctype.js': '1yOus', './raw.js': 'blSdS', './text.js': '367Py', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  j5aki: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef {import('./lib/index.js').LightOptions} LightOptions
 * @typedef {import('./lib/index.js').Options} Options
 */ const _indexJs = require('./lib/index.js');
    parcelHelpers.exportAll(_indexJs, exports);
  }, { './lib/index.js': '47PI5', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '47PI5': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ const _coreJs = require('./core.js');
    const _formatSmartJs = require('./util/format-smart.js');
    const _formatBasicJs = require('./util/format-basic.js');
    function stringifyEntities(value, options) {
      return (0, _coreJs.core)(value, { format: (0, _formatSmartJs.formatSmart), ...options });
    }
    function stringifyEntitiesLight(value, options) {
      return (0, _coreJs.core)(value, { format: (0, _formatBasicJs.formatBasic), ...options });
    }
  }, {
    './core.js': '2CPCe', './util/format-smart.js': 'knP7d', './util/format-basic.js': 'bFhCV', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '2CPCe': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef CoreOptions
 ...
 */ function charactersToExpression(subset) {
  ...
  knP7d: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ const _toHexadecimalJs = require('./to-hexadecimal.js');
    const _toDecimalJs = require('./to-decimal.js');
    const _toNamedJs = require('./to-named.js');
    ...
    './to-hexadecimal.js': 'doh3p', './to-decimal.js': 'hyRX0', './to-named.js': '4g27v', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  doh3p: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'toHexadecimal', () => toHexadecimal);
  ...
  hyRX0: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'toDecimal', () => toDecimal);
  ...
  '4g27v': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'toNamed', () => toNamed);
    const _characterEntitiesLegacy = require('character-entities-legacy');
    const _characterEntitiesHtml4 = require('character-entities-html4');
    const _dangerousJs = require('../constant/dangerous.js');
    const own = {}.hasOwnProperty;
    /**
 ...
 */ const characters = {};
    ...
    'character-entities-legacy': 'bnOAG', 'character-entities-html4': 'dBDGd', '../constant/dangerous.js': '2vt4l', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  bnOAG: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  dBDGd: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  '2vt4l': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  bFhCV: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'formatBasic', () => formatBasic);
  ...
  a7P1B: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 ...
 */ parcelHelpers.export(exports, 'ccount', () => ccount);
  ...
  '3Z5AU': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
  ...
  fNZ7O: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
 ...
 */ const _stringifyEntities = require('stringify-entities');
    ...
    // See: <https://html.spec.whatwg.org/multipage/syntax.html#comments>
      return ctx.bogusComments ? `<?${(0, _stringifyEntities.stringifyEntities)(node.value, {
        ...ctx.entities,
        subset: [
          '>',
        ],
   ...
   * @param {string} $0
   */ function encode($0) {
        return (0, _stringifyEntities.stringifyEntities)($0, {
          ...ctx.entities,
          subset: [
            '<',
            '>',
  ...
  }, { 'stringify-entities': 'j5aki', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '1yOus': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef {import('./types.js').Handle} Handle
 ...
 */ parcelHelpers.export(exports, 'doctype', () => doctype);
  ...
  blSdS: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
 ...
 */ const _textJs = require('./text.js');
  ...
  }, { './text.js': '367Py', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '367Py': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
 ...
 */ const _stringifyEntities = require('stringify-entities');
    ...
    // Check if content of `node` should be escaped.
      return parent && parent.type === 'element' && (parent.tagName === 'script' || parent.tagName === 'style') ? node.value : (0, _stringifyEntities.stringifyEntities)(node.value, {
        ...ctx.entities,
        subset: [
          '<',
          '&',
  ...
  c898u: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef {import('./lib/types.js').Options} Options
 */ parcelHelpers.export(exports, 'toHtml', () => (0, _indexJs.toHtml));
    var _indexJs = require('./lib/index.js');
  }, { './lib/index.js': '3Pqes', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '3Pqes': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Node|Array.<Node>} node
 ...
 */ const _propertyInformation = require('property-information');
    ...
    'property-information': '9xjkX', 'html-void-elements': 'fUgx7', './omission/index.js': 'lFIFU', './tree.js': 'g9BfU', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '9xjkX': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'find', () => (0, _findJs.find));
    parcelHelpers.export(exports, 'hastToReact', () => (0, _hastToReactJs.hastToReact));
 ...
 */ const _mergeJs = require('./lib/util/merge.js');
    ...
    './lib/util/merge.js': 'bA18U', './lib/xlink.js': 'dPUJb', './lib/xml.js': '1CTR2', './lib/xmlns.js': 'kLlZk', './lib/aria.js': '5Rvig', './lib/html.js': '1wsQi', './lib/svg.js': 'cwrha', './lib/find.js': 'f8xh9', './lib/hast-to-react.js': false, './lib/normalize.js': '4RPtu', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  bA18U: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Schema[]} definitions
 ...
 */ const _schemaJs = require('./schema.js');
  ...
  }, { './schema.js': '5Q4Yb', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
 ...
 */ parcelHelpers.export(exports, 'Schema', () => Schema);
  ...
  }, { './util/create.js': 'd3jUe', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  d3jUe: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Definition} definition
 ...
 */ const _normalizeJs = require('../normalize.js');
    ...
    '../normalize.js': '4RPtu', './schema.js': '5Q4Yb', './defined-info.js': '3rtLg', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '4RPtu': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {string} value
 ...
 */ function mark(values, key, value) {
  ...
  }, { './info.js': '7EkGP', './types.js': 'lV7ME', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '7EkGP': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'Info', () => Info);
    class Info {
  ...
  kLlZk: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'xmlns', () => xmlns);
    const _createJs = require('./util/create.js');
  ...
  }, { './util/create.js': 'd3jUe', './util/case-insensitive-transform.js': '87xkY', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '87xkY': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Record<string, string>} attributes
 ...
 */ parcelHelpers.export(exports, 'caseInsensitiveTransform', () => caseInsensitiveTransform);
  ...
  }, { './case-sensitive-transform.js': 'kFRRJ', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  kFRRJ: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Record<string, string>} attributes
 ...
 */ parcelHelpers.export(exports, 'caseSensitiveTransform', () => caseSensitiveTransform);
  ...
  }, { './util/types.js': 'lV7ME', './util/create.js': 'd3jUe', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '1wsQi': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'html', () => html);
    const _typesJs = require('./util/types.js');
    ...
    './util/types.js': 'lV7ME', './util/create.js': 'd3jUe', './util/case-insensitive-transform.js': '87xkY', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  cwrha: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'svg', () => svg);
    const _typesJs = require('./util/types.js');
    ...
    './util/types.js': 'lV7ME', './util/create.js': 'd3jUe', './util/case-sensitive-transform.js': 'kFRRJ', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  f8xh9: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {Schema} schema
 ...
 */ function camelcase($0) {
    ...
    './normalize.js': '4RPtu', './util/defined-info.js': '3rtLg', './util/info.js': '7EkGP', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  fUgx7: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'htmlVoidElements', () => htmlVoidElements);
    const htmlVoidElements = [
  ...
  lFIFU: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'omission', () => omission);
    /**
 ...
 */ const _openingJs = require('./opening.js');
  ...
  }, { './opening.js': '9IbDY', './closing.js': 'gKccf', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '9IbDY': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'opening', () => opening);
    /**
 ...
 */ function tbody(node, index, parent) {
    ...
    'hast-util-is-element': '3633n', './util/comment.js': '4Z2i4', './util/siblings.js': '6nHkx', './util/whitespace-start.js': 'bUi9p', './closing.js': 'gKccf', './omission.js': 'dvtJT', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  '3633n': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'isElement', () => isElement);
    parcelHelpers.export(exports, 'convertElement', () => convertElement);
 ...
 */ function element(node) {
  ...
  '4Z2i4': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'comment', () => comment);
    /**
 ...
 */ const _unistUtilIs = require('unist-util-is');
    const comment = (0, _unistUtilIs.convert)('comment');
  }, { 'unist-util-is': 'chogK', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  chogK: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'is', () => is);
    parcelHelpers.export(exports, 'convert', () => convert);
 ...
 */ function castFactory(check) {
  ...
  '6nHkx': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'siblingAfter', () => siblingAfter);
    parcelHelpers.export(exports, 'siblingBefore', () => siblingBefore);
 ...
 */ function siblings(increment) {
  ...
  }, { 'hast-util-whitespace': '8flFy', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '8flFy': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @param {unknown} thing
 ...
 */ parcelHelpers.export(exports, 'whitespace', () => whitespace);
  ...
  bUi9p: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Check if `node` starts with whitespace.
 ...
 */ const _unistUtilIs = require('unist-util-is');
  ...
  }, { 'unist-util-is': 'chogK', 'hast-util-whitespace': '8flFy', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  gKccf: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'closing', () => closing);
    /**
 ...
 */ function cells(_, index, parent) {
    ...
    'hast-util-is-element': '3633n', './util/comment.js': '4Z2i4', './util/siblings.js': '6nHkx', './util/whitespace-start.js': 'bUi9p', './omission.js': 'dvtJT', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  dvtJT: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Factory to check if a given node can have a tag omitted.
 ...
 */ const own = {}.hasOwnProperty;
  ...
  g9BfU: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
 ...
 */ // eslint-disable-next-line complexity
    ...
    'property-information': '9xjkX', 'space-separated-tokens': 'gsC2E', 'comma-separated-tokens': '6DPAv', 'stringify-entities': 'bVgcP', ccount: '3gpcS', './constants.js': '9GJIh', './comment.js': '6xJn3', './doctype.js': '3xnm1', './raw.js': '2AavL', './text.js': 'YdZUd', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
 ...
 */ parcelHelpers.export(exports, 'stringify', () => stringify);
  ...
  bVgcP: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef {import('./lib/index.js').LightOptions} LightOptions
 ...
 */ const _indexJs = require('./lib/index.js');
    parcelHelpers.exportAll(_indexJs, exports);
  }, { './lib/index.js': '9SK3w', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '9SK3w': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Encode special characters in `value`.
 ...
 */ const _coreJs = require('./core.js');
    ...
    './core.js': 'b76U1', './util/format-smart.js': 'tAuvA', './util/format-basic.js': 'dkvoz', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  b76U1: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef CoreOptions
 ...
 */ function charactersToExpression(subset) {
  ...
  tAuvA: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Configurable ways to encode a character yielding pretty or small results.
 ...
 */ const _toHexadecimalJs = require('./to-hexadecimal.js');
    ...
    './to-hexadecimal.js': 'dFmG6', './to-decimal.js': 'a22jQ', './to-named.js': 'Zl1c0', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  dFmG6: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Configurable ways to encode characters as hexadecimal references.
 ...
 */ parcelHelpers.export(exports, 'toHexadecimal', () => toHexadecimal);
  ...
  a22jQ: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Configurable ways to encode characters as decimal references.
 ...
 */ parcelHelpers.export(exports, 'toDecimal', () => toDecimal);
  ...
  Zl1c0: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Configurable ways to encode characters as named references.
 ...
 */ const characters = {};
    ...
    'character-entities-legacy': 'cTWHy', 'character-entities-html4': '5wxbO', '../constant/dangerous.js': 'gOS5x', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
  }],
  cTWHy: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'characterEntitiesLegacy', () => characterEntitiesLegacy);
    const characterEntitiesLegacy = [
  ...
  '5wxbO': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'characterEntitiesHtml4', () => characterEntitiesHtml4);
    const characterEntitiesHtml4 = {
  ...
  gOS5x: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'dangerous', () => dangerous);
    const dangerous = [
  ...
  dkvoz: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * The smallest way to encode a character.
 ...
 */ parcelHelpers.export(exports, 'formatBasic', () => formatBasic);
  ...
  '3gpcS': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * Count how often a character (or substring) is used in a string.
 ...
 */ parcelHelpers.export(exports, 'ccount', () => ccount);
  ...
  '9GJIh': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers.export(exports, 'constants', () => constants);
    const constants = {
  ...
  '6xJn3': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
 ...
 */ const _stringifyEntities = require('stringify-entities');
  ...
  }, { 'stringify-entities': 'bVgcP', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  '3xnm1': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @typedef {import('./types.js').Handle} Handle
 ...
 */ parcelHelpers.export(exports, 'doctype', () => doctype);
  ...
  '2AavL': [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
 ...
 */ const _textJs = require('./text.js');
  ...
  }, { './text.js': 'YdZUd', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' }],
  YdZUd: [function (require, module, exports) {
    const parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
    parcelHelpers.defineInteropFlag(exports);
    /**
 * @type {Handle}
...
}, ['1JEHZ', 'adjPd'], 'adjPd', 'parcelRequire6330'));
